...
static t_error utils_uInt64Serialize (int argc, t_atom *argv, uint64_t *n)
{
    if (argc >= 16) {
    //
    int i;
...
static t_error utils_uInt64Deserialize (int argc, t_atom *argv, uint64_t *n)
{
    if (argc >= 16) {
    //
...
{
    static uint64_t t = 0; t += 2; return t;        /* Identifiers generated by the core are evens. */
}
