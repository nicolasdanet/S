...
PD_LOCAL void post_log (const char *, ...);
...
PD_LOCAL double atomic_float64ReadRelaxed   (t_float64Atomic *);
PD_LOCAL void   atomic_float64WriteRelaxed  (double, t_float64Atomic *);
