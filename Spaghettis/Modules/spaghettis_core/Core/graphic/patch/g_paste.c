...
PD_GUARD void glist_copy (t_glist *glist)
{
    clipboard_copy (glist);
}

PD_GUARD void glist_cut (t_glist *glist)
{
    glist_copy (glist);
...
PD_GUARD void glist_paste (t_glist *glist)
{
    clipboard_paste (glist);
}

PD_GUARD void glist_duplicate (t_glist *glist)
{
