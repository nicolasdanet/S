...
static void gui_update (int flag, t_gui *x, const Tags& t)
{
    if (flag & GUI_FLAG_NOTIFY) {
        if (flag & GUI_FLAG_DIRTY) { outputs_objectUpdated (cast_object (x), t); }
        else {
...
int gui_updateValue (t_gui *x, t_float f, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Value));
        #endif
    }
...
int gui_updateState (t_gui *x, int n, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::State));
        #endif
    }
...
void gui_updateRange (t_gui *x, t_float minimum, t_float maximum, int flag)
{
    ...
    if (flag) {
        if (min != x->x_low) {
            #if defined ( PD_BUILDING_APPLICATION )
            gui_update (flag, x, Tags::parameters (Tag::Low));
            #endif
        }
        if (max != x->x_high) {
            #if defined ( PD_BUILDING_APPLICATION )
            gui_update (flag, x, Tags::parameters (Tag::High));
            #endif
        }
    }
}
...
void gui_updateInterval (t_gui *x, t_float interval, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Interval));
        #endif
    }
    //
    }
...
void gui_updateNonZero (t_gui *x, t_float f, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::NonZero));
        #endif
    }
    //
    }
...
int gui_updatePeak (t_gui *x, t_float f, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Peak));
        #endif
    }
...
void gui_updateLogarithmic (t_gui *x, int isLogarithmic, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Logarithmic));
        #endif
    }
    //
    }
...
void gui_updateMultiple (t_gui *x, int isMultiple, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Multiple));
        #endif
    }
    //
    }
...
void gui_updateOrientation (t_gui *x, int isVertical, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Vertical));
        #endif
    }
...
void gui_updateOrientationSwap (t_gui *x, int isVertical, int flag)
{
    ...
    //
    #if defined ( PD_BUILDING_APPLICATION )
    gui_update (flag, x, Tags::parameters ( { Tag::Vertical, Tag::Width, Tag::Height } ));
    #endif
    //
    }
...
void gui_updateFlashed (t_gui *x, int n, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Flashed));
        #endif
    }
    //
    }
...
void gui_updateEmbedded (t_gui *x, int n, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Embedded));
        #endif
    }
    //
    }
...
void gui_updateTime (t_gui *x, int n, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::FlashTime));
        #endif
    }
    //
    }
...
void gui_updateDigits (t_gui *x, int digits, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Digits));
        #endif
    }
    //
    }
...
void gui_updateButtons (t_gui *x, int buttons, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Buttons));
        #endif
    }
    //
    }
...
void gui_updateWidth (t_gui *x, int width, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Width));
        #endif
    }
...
void gui_updateHeight (t_gui *x, int height, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Height));
        #endif
    }
...
void gui_updateIncluded (t_gui *x, int n, t_symbol *s, int flag)
{
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Included));
        #endif
    }
    //
    }
    ...
    if (flag) {
        #if defined ( PD_BUILDING_APPLICATION )
        gui_update (flag, x, Tags::parameters (Tag::Label));
        #endif
    }
    //
    }
...
bool gui_setParameters (t_object *o, const data::Group& group, int flags)
{
    ...
    if (flags & GUI_INCLUDED) {
        ...
        gui_updateIncluded (x, n, s, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_RANGE) {
        ...
        gui_updateRange (x, min, max, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_INTERVAL) {
        ...
        gui_updateInterval (x, interval, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_NONZERO) {
        ...
        gui_updateNonZero (x, nonzero, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_LOGARITHMIC) {
        ...
        gui_updateLogarithmic (x, logarithmic, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_MULTIPLE) {
        ...
        gui_updateMultiple (x, multiple, GUI_UPDATE_NOTIFY_DIRTY);
    }
    ...
    if (flags & GUI_BUTTONS) {
        ...
        gui_updateButtons (x, buttons, GUI_UPDATE_NOTIFY_DIRTY);
    }
...
void gui_restore (t_gui *x, int flags)
{
    ...
    if (y) {
    //
    int t = GUI_UPDATE_NOTIFY;
    
    if (flags & GUI_RANGE)          { gui_updateRange (x, gui_getLow (y), gui_getHigh (y), t);          }
    if (flags & GUI_INTERVAL)       { gui_updateInterval (x, gui_getInterval (y), t);                   }
    if (flags & GUI_NONZERO)        { gui_updateNonZero (x, gui_getNonZero (y), t);                     }
    if (flags & GUI_LOGARITHMIC)    { gui_updateLogarithmic (x, gui_isLogarithmic (y), t);              }
    if (flags & GUI_MULTIPLE)       { gui_updateMultiple (x, gui_isMultiple (y), t);                    }
    if (flags & GUI_EMBEDDED)       { gui_updateEmbedded (x, gui_isEmbedded (y), t);                    }
    if (flags & GUI_TIME)           { gui_updateTime (x, gui_getTime (y), t);                           }
    if (flags & GUI_DIGITS)         { gui_updateDigits (x, gui_getDigits (y), t);                       }
    if (flags & GUI_BUTTONS)        { gui_updateButtons (x, gui_getButtons (y), t);                     }
    if (flags & GUI_WIDTH)          { gui_updateWidth (x, gui_getWidth (y), t);                         }
    if (flags & GUI_HEIGHT)         { gui_updateHeight (x, gui_getHeight (y), t);                       }
    if (flags & GUI_ORIENTATION)    { gui_updateOrientation (x, gui_isVertical (y), t);                 }
    if (flags & GUI_VALUE)          { gui_updateValue (x, gui_getValue (y), t);                         }
    if (flags & GUI_PEAK)           { gui_updatePeak (x, gui_getPeak (y), t);                           }
    if (flags & GUI_STATE)          { gui_updateState (x, gui_getState (y), t);                         }
    if (flags & GUI_INCLUDED)       { gui_updateIncluded (x, gui_isIncluded (y), gui_getLabel (y), t);  }
    //
    }
}

void gui_include (t_gui *x, int n, t_atom *a)
{
    int t = GUI_UPDATE_NOTIFY;
     
    gui_updateIncluded (x, atom_getFloatAtIndex (0, n, a), atom_getSymbolAtIndex (1, n, a), t);
}
