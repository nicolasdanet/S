...
private:
    virtual void paintPerform (const juce::Rectangle<int>&, juce::Graphics&) = 0;
    
    virtual juce::Rectangle<float> getRequiredBoundsPerform() = 0;
...
public:
    ...
    juce::Rectangle<float> getRequiredBounds();
