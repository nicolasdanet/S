...
const char* bng_xml = (const char*) temp_binary_data_0;
...
const char* construction_svg = (const char*) temp_binary_data_2;
...
const char* delete_forever_svg = (const char*) temp_binary_data_3;
...
const char* error_outline_svg = (const char*) temp_binary_data_4;
...
const char* getNamedResource (const char* resourceNameUTF8, int& numBytes)
{
    ...
    switch (hash)
    {
        case 0x01b03773:  numBytes = 358; return bng_xml;
