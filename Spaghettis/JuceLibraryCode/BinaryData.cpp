...
const char* construction_svg = (const char*) temp_binary_data_1;
...
const char* delete_forever_svg = (const char*) temp_binary_data_2;
...
const char* error_outline_svg = (const char*) temp_binary_data_3;

//================== help_outline.svg ==================
static const unsigned char temp_binary_data_4[] =
"<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 0 24 24\" width=\"24px\" fill=\"#000000\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M11 18h2v-2h-2v2zm1-16C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0"
" 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2c0 2-3 1.75-3 5h2c0-2.25 3-2.5 3-5 0-2.21-1.79-4-4-4z\"/></svg>";

const char* help_outline_svg = (const char*) temp_binary_data_4;
...
const char* mail_svg = (const char*) temp_binary_data_6;
...
const char* place_svg = (const char*) temp_binary_data_7;
...
const char* restore_svg = (const char*) temp_binary_data_8;

//================== search_off.svg ==================
static const unsigned char temp_binary_data_9[] =
"<svg xmlns=\"http://www.w3.org/2000/svg\" enable-background=\"new 0 0 24 24\" height=\"24px\" viewBox=\"0 0 24 24\" width=\"24px\" fill=\"#000000\"><g><rect fill=\"none\" height=\"24\" width=\"24\"/></g><g><g><path d=\"M15.5,14h-0.79l-0.28-0.27C15.41"
",12.59,16,11.11,16,9.5C16,5.91,13.09,3,9.5,3C6.08,3,3.28,5.64,3.03,9h2.02 C5.3,6.75,7.18,5,9.5,5C11.99,5,14,7.01,14,9.5S11.99,14,9.5,14c-0.17,0-0.33-0.03-0.5-0.05v2.02C9.17,15.99,9.33,16,9.5,16 c1.61,0,3.09-0.59,4.23-1.57L14,14.71v0.79l5,4.99L20.49,1"
"9L15.5,14z\"/><polygon points=\"6.47,10.82 4,13.29 1.53,10.82 0.82,11.53 3.29,14 0.82,16.47 1.53,17.18 4,14.71 6.47,17.18 7.18,16.47 4.71,14 7.18,11.53\"/></g></g></svg>";

const char* search_off_svg = (const char*) temp_binary_data_9;
...
const char* sync_svg = (const char*) temp_binary_data_10;
...
const char* system_update_alt_svg = (const char*) temp_binary_data_11;
...
const char* text_rotate_up_svg = (const char*) temp_binary_data_12;
...
const char* text_rotation_down_svg = (const char*) temp_binary_data_13;
...
const char* tune_svg = (const char*) temp_binary_data_14;
...
const char* visibility_svg = (const char*) temp_binary_data_15;

//================== zoom_in.svg ==================
static const unsigned char temp_binary_data_16[] =
"<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 0 24 24\" width=\"24px\" fill=\"#000000\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5"
" 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zm.5-7H9v2H7v1h2v2h1v-2h2V9h-2z\"/></svg>";

const char* zoom_in_svg = (const char*) temp_binary_data_16;

//================== zoom_out.svg ==================
static const unsigned char temp_binary_data_17[] =
"<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 0 24 24\" width=\"24px\" fill=\"#000000\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5"
" 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM7 9h5v1H7z\"/></svg>";

const char* zoom_out_svg = (const char*) temp_binary_data_17;
...
const char* getNamedResource (const char* resourceNameUTF8, int& numBytes)
{
    ...
    switch (hash)
    {
        ...
        case 0xb22e2df6:  numBytes = 723; return construction_svg;
        case 0xdc6c4ef8:  numBytes = 368; return delete_forever_svg;
        case 0xf4b96930:  numBytes = 292; return error_outline_svg;
        case 0x3f3e58e9:  numBytes = 402; return help_outline_svg;
        case 0x0aa04b53:  numBytes = 307; return info_svg;
        case 0xff683fdc:  numBytes = 277; return mail_svg;
        case 0x6ad7eb2c:  numBytes = 386; return place_svg;
        case 0x13afc933:  numBytes = 372; return restore_svg;
        case 0xacea2ffd:  numBytes = 647; return search_off_svg;
        ...
        case 0x00b2b19d:  numBytes = 278; return tune_svg;
        case 0x1cf777b7:  numBytes = 493; return visibility_svg;
        case 0xc0395636:  numBytes = 423; return zoom_in_svg;
        case 0x91678d87:  numBytes = 404; return zoom_out_svg;
        default: break;
    }
